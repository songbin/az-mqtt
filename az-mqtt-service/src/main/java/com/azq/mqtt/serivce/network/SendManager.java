package com.azq.mqtt.serivce.network;
...
public class SendManager {
    //private static final Map<String, ContextBo> sessionRepository = new ConcurrentHashMap<>();
    ...
    public static void sendMessage(MqttMessage msg, String clientId, Integer packetId, boolean flush) {
        //ChannelHandlerContext ctx = getSession(clientId).getHandlerContext();
    ...
    public static void pubMsg(MqttPublishMessage msg, ContextBo contextBo) {
        ...
        try {
            ...
            //   logger.debug("发给了:"+clientId+"主题:"+msg.variableHeader().topicName());
